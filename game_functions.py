...
"""Event Listeners"""
def check_b_play(sett,screen,stats,sb,b_play,ship,aliens,bullets,mouse_x,mouse_y):
...
def check_events(sett,screen,stats,sb,b_play,ship,aliens,bullets):
    for event in pygame.event.get():
        if event.type==pygame.QUIT:
            ...
            check_b_play(sett,screen,stats,sb,b_play,ship,aliens,bullets,mouse_x,mouse_y)
...
def update_screen(sett,screen,stats,sb,ship,aliens,bullets,b_play):
    ...
    #Draw the score info
    sb.show_score()
    #Draw Play button if game not active and display highscore to beat
