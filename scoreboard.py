...
class ScoreBoard():
    ...
    def prep_highscore(self):
        ...
        self.highscore_image=self.font.render(highscore_str,True,self.text_color,self.sett.bg_color)
    ...
    def prep_level(self):
        ...
        self.level_image=self.font.render(str(self.stats.level),True,self.text_color,self.sett.bg_color)
